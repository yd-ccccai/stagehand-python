...
class ObserveHandler:
    ...
    def __init__(self, stagehand_page, stagehand_client, user_provided_instructions=None):
        """
    ...
    async def observe(
        ...
        self.logger.info(
            "Found elements", 
            extra={"elements": elements_with_selectors}
        )
    ...
    async def _add_selectors_to_elements(
        self, elements: List[Dict[str, Any]], selector_map: Dict[str, List[str]], 
        ...
        for element in elements:
            ...
            if use_accessibility_tree:
                ...
                self.logger.info(
                    ...
                    extra={"elementId": str(element_id)}
                )
                ...
                if not object_id:
                    self.logger.info(f"Invalid object ID returned for element: {element_id}")
                    continue
